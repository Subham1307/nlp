...
class HindiTextExtractionAgent(BaseAgent):
    def __init__(self, api_key):
        super().__init__()
        self.client = genai.Client(api_key=api_key)
        self.prompt = """
**Task Description**
Understand the layout of a textbook page written in **Hindi**, which may include **boxes containing text**.
...
"""
    ...
    def _to_sentence_list(self, raw_text: str) -> list[str]:
        ...
        Handles bullets, numbering, and common Hindi punctuation.
        """
